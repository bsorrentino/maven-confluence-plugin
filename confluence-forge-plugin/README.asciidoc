...
:idprefix: id_ 
(choose one, do not modify, then add a second sentence with a brief description, starting with - "The confluence-forge-plugin addon enables blah blah...)
...
----
<dependency>
   <groupId>org.confluence.forge.plugin</groupId>
