...
public class PluginConfluenceDocGenerator implements Generator {
	 ...
	 * @param space
	 */
	public PluginConfluenceDocGenerator( Confluence confluence, Page parentPage ) {
    ...
    private void writeSummary( Writer writer, PluginDescriptor pluginDescriptor, List<MojoDescriptor> mojos ) {
    	...
    	w.printInfo( "auto generated page", 
    			"this page has been generated by Factory plugin : " + 
    			"cosm.maven.plugin:cosm-confluence-plugin" );
    ...
    private void writeParameterDetails( List<Parameter> parameterList, ConfluenceWikiWriter w )
    {
        ...
        for ( Parameter parameter : parameterList )
        {
            ...
            writeDetail( "Expression", decode(parameter.getExpression()), w );

            writeDetail( "Default", decode(parameter.getDefaultValue()), w );
