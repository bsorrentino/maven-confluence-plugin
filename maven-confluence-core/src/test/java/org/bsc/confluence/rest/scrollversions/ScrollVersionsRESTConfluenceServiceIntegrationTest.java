...
public class ScrollVersionsRESTConfluenceServiceIntegrationTest extends AbstractRestConfluence {
    ...
    private static final String SCROLL_VERSIONS_VERSION = "BETA";
    private static final String SCROLL_VERSIONS_SPACE_KEY = "TESTSV";

    private ScrollVersionsRESTConfluenceService scrollVersionsRESTConfluenceService = new ScrollVersionsRESTConfluenceService(URL, SCROLL_VERSIONS_VERSION, credentials, sslInfo );
